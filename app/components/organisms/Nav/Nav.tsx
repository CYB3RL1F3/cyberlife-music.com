...
const Nav = ({ routes, children, isOpen }: NavProps) => {
  return (
    <NavContextProvider routes={routes}>
      <nav
        className={clsx(
          "top-0 z-10 w-full h-screen p-12 mt-12 bg-gray-800 md:mt-0 max-md:backdrop-blur-md md:p-0 bg-opacity-70 md:bg-transparent max-md:absolute md:h-auto md:w-auto md:flex md:flex-col md:flex-end transition-all duration-75 ease-in-out",
          {
