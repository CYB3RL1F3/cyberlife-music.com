...
// ====================================================
// GraphQL query operation: SummaryQuery
// ====================================================
...
export interface SummaryQuerySummaryNextEvent {
   ...
   * time (begin / end)
   */
  flyer: SummaryQuerySummaryNextEventFlyer | null;
}
...
export interface SummaryQuerySummaryLatestReleasesRelease {
   ...
   * Release tracklist
   */
  tracklist: SummaryQuerySummaryLatestReleasesReleaseTracklist[] | null;
  /**
   * Release discogs
   */
  discogs: string | null;
...
export interface SummaryQuerySummaryLatestReleases {
   ...
   * Item release
   */
  release: SummaryQuerySummaryLatestReleasesRelease | null;
}
...
export interface SummaryQuerySummary {
   ...
   * Next event
   */
  nextEvent: SummaryQuerySummaryNextEvent | null;
  /**
   * top podcast
   */
  topPodcast: SummaryQuerySummaryTopPodcast | null;
  /**
   * latest podcast
   */
  latestPodcast: SummaryQuerySummaryLatestPodcast | null;
  /**
   * Recent releases
   */
  latestReleases: SummaryQuerySummaryLatestReleases[] | null;
  /**
   * Latest video
   */
  latestVideo: SummaryQuerySummaryLatestVideo | null;
}

export interface SummaryQuery {
  summary: SummaryQuerySummary;
}
...
export interface SummaryQueryVariables {
  ...
  webshopId: string;
  topPodcastId: string;
  expectedNbReleases?: number | null;
}
